...
import { writingList } from "./writing";
...
export const writingIndex: WritingIndex[] = [
  ...
  },
  {
    ...
    image: "src/assets/img/cover/git-basic.jpg",
    content: "Git의 기본 개념과 로컬-원격 워크플로를 초보자 관점에서 정리한 짧은 가이드입니다.",
    seriesTitle: "123333333333333333333"
  },
  {
    ...
    mainCategory: "프론트엔드",
    subCategory: "React",
    image: "src/assets/img/cover/html-basic.jpg",
    content: "HTML 기본 구조와 자주 쓰는 태그를 실습 예제와 함께 설명합니다."
  },
  {
    ...
    image: "src/assets/img/cover/markdown-basic.jpg",
    content: "README나 블로그용 문서를 빠르게 작성할 수 있는 Markdown 핵심 문법을 정리합니다."
  }
];
